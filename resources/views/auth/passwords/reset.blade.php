                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">{{ __('Alterar Senha') }}</h1>
                                </div>
                                ...
                                <form method="POST" action="{{ route('password.update') }}" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="email" class="form-control form-control-user" name="email" placeholder="{{ __('Endereço de e-mail) }}" value="{{ $email ?? old('email') }}" required autofocus>
                                    </div>
